...
int table[3][3],win_player1=0,win_player2=0,win_player_AI=0,win_AI=0,who_win=0,win=1,n=3,cache_x[100],cache_o[100],exits,turn=0;
Locate locate;
...
void turn_play(int AI,int player)
{
	int stop,num=0;
	char numchar='0';
	do
...
void normal()
{
	...
	do
	{
		for(int i=1;i<=2;i++)
		{
			...
			turn_play(0,i);
			count++;
			if(count==n*n+1||who_win!=0||!exits) break;
		}
